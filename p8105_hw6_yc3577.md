...
```
    ...
    ##  1      1 <tibble> (Intercept)  7.75      0.236       32.8  1.71e-110     0.918
    ##  2      1 <tibble> tmin         1.04      0.0163      63.4  3.35e-198     0.918
    ##  3      1 <tibble> prcp        -0.00276   0.00193     -1.43 1.54e-  1     0.918
    ##  4      2 <tibble> (Intercept)  8.09      0.240       33.7  1.04e-113     0.912
    ##  5      2 <tibble> tmin         1.01      0.0165      61.1  7.13e-193     0.912
    ##  6      2 <tibble> prcp         0.00484   0.00224      2.16 3.12e-  2     0.912
    ##  7      3 <tibble> (Intercept)  7.89      0.213       37.1  2.09e-125     0.926
    ##  8      3 <tibble> tmin         1.03      0.0153      67.3  1.10e-206     0.926
    ##  9      3 <tibble> prcp        -0.00306   0.00185     -1.66 9.79e-  2     0.926
    ## 10      4 <tibble> (Intercept)  7.76      0.213       36.5  2.84e-123     0.933
    ## # ℹ 14,990 more rows
...
```
    ...
    ##  1      1     0.918          7.75  1.04 -0.00276   NaN   
    ##  2      2     0.912          8.09  1.01  0.00484    -5.32
    ##  3      3     0.926          7.89  1.03 -0.00306   NaN   
    ##  4      4     0.933          7.76  1.03 -0.00551   NaN   
    ##  5      5     0.932          8.29  1.03 -0.00856   NaN   
    ##  6      6     0.912          8.07  1.00  0.00614    -5.09
    ##  7      7     0.929          7.81  1.03 -0.00228   NaN   
    ##  8      8     0.911          8.20  1.01 -0.00190   NaN   
    ##  9      9     0.915          8.18  1.01 -0.00228   NaN   
    ## 10     10     0.939          7.63  1.04 -0.00610   NaN   
    ## # ℹ 4,990 more rows
...
```
    ...
    ## Warning: Removed 3283 rows containing non-finite values (`stat_density()`).
...
## Compare your model to two others: One using length at birth and gestational age as predictors (main effects only)
