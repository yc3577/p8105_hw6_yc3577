...
```
    ...
    ##  1      1 <tibble> (Intercept)   7.84e+0   0.243     32.3    1.00e-108     0.911
    ##  2      1 <tibble> tmin          1.02e+0   0.0169    60.6    1.30e-191     0.911
    ##  3      1 <tibble> prcp         -3.59e-5   0.00189   -0.0190 9.85e-  1     0.911
    ##  4      2 <tibble> (Intercept)   7.86e+0   0.279     28.2    1.97e- 93     0.893
    ##  5      2 <tibble> tmin          1.01e+0   0.0185    54.7    5.08e-177     0.893
    ##  6      2 <tibble> prcp          6.45e-3   0.00236    2.73   6.71e-  3     0.893
    ##  7      3 <tibble> (Intercept)   8.18e+0   0.237     34.5    2.28e-116     0.905
    ##  8      3 <tibble> tmin          1.01e+0   0.0172    58.8    2.63e-187     0.905
    ##  9      3 <tibble> prcp          2.96e-3   0.00195    1.52   1.29e-  1     0.905
    ## 10      4 <tibble> (Intercept)   8.08e+0   0.238     33.9    2.79e-114     0.911
    ## # ℹ 14,990 more rows
...
```
    ...
    ##  1      1     0.911          7.84  1.02 -0.0000359   NaN   
    ##  2      2     0.893          7.86  1.01  0.00645      -5.03
    ##  3      3     0.905          8.18  1.01  0.00296      -5.81
    ##  4      4     0.911          8.08  1.02 -0.00714     NaN   
    ##  5      5     0.889          8.10  1.01  0.00220      -6.11
    ##  6      6     0.921          7.96  1.03 -0.00135     NaN   
    ##  7      7     0.898          8.02  1.00 -0.00101     NaN   
    ##  8      8     0.900          8.01  1.01  0.00779      -4.84
    ##  9      9     0.927          8.04  1.01  0.0000790    -9.44
    ## 10     10     0.907          7.89  1.01  0.00312      -5.76
    ## # ℹ 4,990 more rows
...
```
    ...
    ## Warning: Removed 3334 rows containing non-finite values (`stat_density()`).
