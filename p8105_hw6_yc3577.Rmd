...
```
# The distribution of Log_beta is above with Pink histogram and pink density line. From two graphs, we can see they are left skewed distributed with a long tail on the left. The range is from -14 to -4 and the center of the mode is around -6.
...
```
# The distribution of R_squared is above with blue histogram and blue density curve. From two graphs, we can see they are left skewed distributed with a long tail on the left. The range is from -14 to -4 and the center of the mode is around -6.
